...
A comprehensive hook system inspired by Claude Code's 27+ hook events,
providing lifecycle hooks for every major agent operation.

受 Claude Code 27+ 钩子事件启发的全面钩子系统。
...
Hook Events (27+ lifecycle events):
...
Key features:
    - 27+ hook events for complete lifecycle coverage
...
# Define ALL 27+ hook event names
